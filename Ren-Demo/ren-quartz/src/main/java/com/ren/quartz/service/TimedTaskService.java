...
public interface TimedTaskService extends IService<TimedTask> {
     ...
     */
    void modifyTimedTaskStatusById(long taskId, int status, String updateBy) throws SchedulerException;
     ...
     */
    IPage<TimedTask> listTimedTaskByPage(String searchLike);
     ...
     */
    List<TimedTask> listTimedTaskByParam(Integer status);
     ...
     */
    IPage<TimedTaskLog> listTimedTaskLogByPage(String searchLike);
     ...
     */
    void removeTimedTaskLogById(long taskLogId) throws SchedulerException;
