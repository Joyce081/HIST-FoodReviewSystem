...
public interface TimedTaskMapper extends BaseMapper<TimedTask> {
     ...
     */
    void updateTimedTaskStatusById(@Param("taskId") long taskId, @Param("status") int status,
     ...
     * @date 2025/05/07 17:31
     */
    IPage<TimedTask> listTimedTaskByPage(Page<TimedTask> page, @Param("searchLike") String searchLike);
