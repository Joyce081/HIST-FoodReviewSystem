...
import com.ren.quartz.job.QuartzDisallowConcurrentExecution;
import com.ren.quartz.job.QuartzJobExecution;
...
public class QuartzManager {
	...
	public static void createScheduleJob(Scheduler scheduler, TimedTask timedTask) throws SchedulerException, QuartzException
	{
		...
		if (timedTask.getStatus() == Convert.toInt(QuartzContents.Status.PAUSE.getValue()))
		{
