...
/*
 * @Author: ren
 * @Date: 2025-11-26 11:52:48
 * @LastEditTime: 2025-12-26 14:59:17
 * @LastEditors: ren
 * @Description: 本类是基于数据库的用户信息管理器
 * @FilePath: /Ren-Demo/ren-framework/src/main/java/com/ren/framework/security/config/DBUserDetailsManager.java
 */
@Component
public class DBUserDetailsManager implements UserDetailsManager, UserDetailsPasswordService {
    ...
    public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
        ...
        if (user == null) {
            ...
            if(isAdmin){
                //超级管理员获取所有菜单
                menuList = menuMapper.listMenuByParam(null,null,null,null);
