...
public class AsyncFactory
{
     ...
     */
    public static TimerTask addLogininfor(final String username, final Integer isSuccess, final String message)
    {
    ...
    public static TimerTask sendAddOrModifyNoticeEmail(final Notice notice,final String title)
    {
        ...
        return new TimerTask()
        {
            ...
            {
                //获取所有用户列表，发送邮件
                List<User> userList = userService.listUserByParam(null,null,null,null);
