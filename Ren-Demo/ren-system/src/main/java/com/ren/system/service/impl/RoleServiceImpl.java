...
public class RoleServiceImpl extends ServiceImpl<RoleMapper, Role> implements RoleService {
    ...
    public long addRole(Role role, String createBy) {
        role.setIsDel(AppConstants.COMMON_INT_NO);
     ...
     */
    @Override
    public void modifyRoleIsDelById(long roleId, int isDel, String updateBy) {
     ...
     */
    @Override
    public IPage<Role> listRoleByPage(String searchLike,Integer isStop) {
        if(StringUtils.isNotBlank(searchLike)){
            searchLike = StringUtils.format("%%{}%%",searchLike);
        }
        IPage<Role> roleList = roleMapper.listRoleByPage(PageUtils.createPage(Role.class),searchLike, isStop);
        return roleList;
    }
     ...
     */
    @Override
    public List<Role> listRoleByParam(String searchLike) {
        if(StringUtils.isNotBlank(searchLike)){
            searchLike = StringUtils.format("%%{}%%",searchLike);
        }
        return roleMapper.listRoleByParam(searchLike);
    }
