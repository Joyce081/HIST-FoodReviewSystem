...
public interface RoleMapper extends BaseMapper<Role> {
     ...
     */
    void updateRoleIsDelById(@Param("roleId")long roleId, @Param("isDel")int isDel, @Param("updateBy")String updateBy, @Param("updateTime")long updateTime);
     ...
     */
    IPage<Role> listRoleByPage(Page<Role> page, @Param("searchLike")String searchLike, @Param("isStop")Integer isStop);
     ...
     */
    List<Role> listRoleByParam(String searchLike);
