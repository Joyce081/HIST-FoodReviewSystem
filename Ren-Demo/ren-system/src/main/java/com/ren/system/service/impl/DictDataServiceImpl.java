...
public class DictDataServiceImpl extends ServiceImpl<DictDataMapper, DictData> implements DictDataService {
     ...
     */
    @Override
    public IPage<DictData> listDictDataByPage(String searchLike) {
        if(StringUtils.isNotBlank(searchLike)){
            searchLike = StringUtils.format("%%{}%%",searchLike);
        }
        IPage<DictData> dictDataList = dictDataMapper.listDictDataByPage(PageUtils.createPage(DictData.class),searchLike);
        return dictDataList;
    }
     ...
     */
    @Override
    public DictData getDictDataByParam(String dictType , Integer isDefault) {
