...
public class MenuServiceImpl extends ServiceImpl<MenuMapper, Menu> implements MenuService {
     ...
     */
    @Override
    public List<Menu> listMenuByParam(String menuType,Long parentId,String searchLike,String routeName) {
        if(StringUtils.isNotBlank(searchLike)){
            searchLike = StringUtils.format("%%{}%%",searchLike);
        }
        List<Menu> menuList = menuMapper.listMenuByParam(menuType,parentId,searchLike,routeName);
        return menuList;
    }
     ...
     */
    @Override
    public void modifyMenuIsDelById(long menuId, int isDel, String updateBy) {
