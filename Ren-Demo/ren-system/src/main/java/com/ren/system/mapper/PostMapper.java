...
public interface PostMapper extends BaseMapper<Post> {
     ...
     */
    IPage<Post> listPostByPage(Page<Post> page, @Param("searchLike")String searchLike);
     ...
     */
    List<Post> listPostByParam(@Param("searchLike")String searchLike);
     ...
     * @author ren
     * @date 2025/09/20 14:17
     */
    List<Post> listPostByUserId(@Param("userId")Long userId);
}