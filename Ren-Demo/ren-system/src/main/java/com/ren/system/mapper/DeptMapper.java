...
public interface DeptMapper extends BaseMapper<Dept> {
     ...
     */
    void updateDeptIsDelById(@Param("deptId")long deptId, @Param("isDel")int isDel, @Param("updateBy")String updateBy, @Param("updateTime")long updateTime);
     ...
     * @date 2025/05/07 17:31
     */
    List<Dept> listDeptByParam(String searchLike,Integer isStop,Long parentId);
