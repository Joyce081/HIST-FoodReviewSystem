...
@NoArgsConstructor
@AllArgsConstructor
public class ComputerSystemInfoVO
{
	/**制造商*/
	...
	/**系统位数*/
	@Schema(description = "系统位数")
	private int bitness;
	/**正常运行时间*/
	@Schema(description = "正常运行时间")
	private long systemUptime;
	/**运行中进程数*/
	@Schema(description = "运行中进程数")
	...
	public ComputerSystemInfoVO(ComputerSystem computerSystem, OperatingSystem os){
