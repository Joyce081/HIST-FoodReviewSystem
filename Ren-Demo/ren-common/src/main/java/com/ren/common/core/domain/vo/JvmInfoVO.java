...
public class JvmInfoVO
{
	...
	@Schema(description = "JVM 实现名称")
	private String jvmName;
	/**JVM 实现版本号*/
	@Schema(description = "JVM 实现版本号")
	private String jvmVersion;
	/**JVM 供应商信息*/
	@Schema(description = "JVM 供应商信息")
	private String jvmVendor;
	/**JVM 附加信息 (运行模式等)*/
	@Schema(description = "JVM 附加信息")
	private String jvmInfoStr;
	/**JVM 规范名称*/
	@Schema(description = "JVM 规范名称")
	private String jvmSpecName;
	/**JVM 规范版本*/
	@Schema(description = "JVM 规范版本")
	private String jvmSpecVersion;
	/**JVM 规范维护者*/
	@Schema(description = "JVM 规范维护者")
	private String jvmSpecVendor;
	/**JVM运行参数*/
	@Schema(description = "JVM运行参数")
