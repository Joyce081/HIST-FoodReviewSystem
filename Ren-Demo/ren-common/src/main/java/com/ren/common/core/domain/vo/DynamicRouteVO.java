...
public class DynamicRouteVO implements Serializable
{
    ...
    public class Meta{
        ...
        public Meta(Boolean requiresAuth, String[] roles, String menuShow) {
    ...
    public <T> DynamicRouteVO(
        ...
        this.meta = new Meta(meta.setTitle(Convert.toStr(BeanUtil.getProperty(t, menuNameFieldName))));
