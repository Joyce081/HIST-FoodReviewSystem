...
public class RenApplicationTest {
    ...
    @Test
    public void test() {
        System.out.println("expireTime = " + tokenProperties.getAccessTokenExpireTime());
        System.out.println("secret = " + tokenProperties.getSecret());
        System.out.println("refreshTime = " + tokenProperties.getAccessTokenRefreshTime());
        System.out.println("refreshExpireTime = " + tokenProperties.getRefreshTokenExpireTime());
