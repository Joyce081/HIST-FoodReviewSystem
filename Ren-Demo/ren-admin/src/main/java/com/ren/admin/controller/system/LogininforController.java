...
public class LogininforController extends BaseController {
    ...
    public TableDataInfo listLogininforByPage(@RequestParam(required = false) @Schema(description = "模糊查询") String searchLike) {
        IPage<Logininfor> logininforList = logininforService.listLogininforByPage(searchLike);
    ...
    public AjaxResult logininforDelete(@AuthenticationPrincipal LoginUser loginUser, @Schema(description = "日志标识",type = "long") long logininforId) {
