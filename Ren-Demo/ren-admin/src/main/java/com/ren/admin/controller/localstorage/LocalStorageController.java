...
import com.ren.common.core.domain.schemas.UploadSchemas;
...
public class LocalStorageController {
    ...
    public AjaxResult uploadFile(@Schema(description = "单个文件", type = "string", format = "binary")MultipartFile file, @Schema(description = "文件需要上传至哪个目录下")String belong) throws Exception
    {
        try
        {
            // 上传文件路径
    ...
    @SecurityRequirements({@SecurityRequirement(name = "JWT")})
    public void resourceDownload(@Schema(description = "下载文件路径")String resource, HttpServletRequest request, HttpServletResponse response)
            throws Exception
    {
        try
        {
