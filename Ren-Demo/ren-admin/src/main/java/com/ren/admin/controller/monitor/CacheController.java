...
import com.ren.monitor.core.domain.schemas.CacheDetailSchemas;
...
public class CacheController extends BaseController {
	...
	public AjaxResult cacheKeyList(String name)
	{
		...
		String pattern = name + ":" + "*"; // 匹配所有refresh_token:开头的键
	...
	@SecurityRequirements({@SecurityRequirement(name = "JWT")})
	@ApiResponse(responseCode = "200",description = "成功",content = @Content(mediaType = "application/json", schema = @Schema(implementation = AjaxResultSchemas.class)))
	public AjaxResult cacheKeyDelete(@Schema(description = "组名") String name, @Schema(description = "键名") String key) {
	...
	@SecurityRequirements({@SecurityRequirement(name = "JWT")})
	@ApiResponse(responseCode = "200",description = "成功",content = @Content(mediaType = "application/json", schema = @Schema(implementation = CacheDetailSchemas.class)))
