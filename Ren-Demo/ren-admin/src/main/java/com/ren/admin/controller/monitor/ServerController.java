...
import com.ren.monitor.core.domain.schemas.ServerMonitorSchemas;
...
public class ServerController extends BaseController {
    ...
    @ApiResponse(responseCode = "200",description = "成功",content = @Content(mediaType = "application/json", schema = @Schema(implementation = ServerMonitorSchemas.class)))
