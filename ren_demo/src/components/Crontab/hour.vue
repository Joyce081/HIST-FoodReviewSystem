<template>
	<el-form size="small">
		<el-form-item>
			<el-radio v-model="radioValue" label="小时，允许的通配符[, - * /]" :value="1" />
		</el-form-item>

		<el-form-item>
			<el-radio v-model="radioValue" label="周期从" :value="2" />
		...
		<el-form-item>
			<el-radio v-model="radioValue" label="从" :value="3" />
		...
		<el-form-item>
			<el-row :gutter="10" style="width: 100%">
				<el-col :span="2">
					<el-radio v-model="radioValue" label="指定" :value="4" />
				</el-col>
				<el-col :span="22">
					<el-select
							clearable
